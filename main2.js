...
const CargarPeliculas= async () => {
    try {
        const respuesta= await fetch(`https://api.themoviedb.org/3/movie/popular?api_key=ff60f9dde54fdfe327e270d3d7cc6307&language=es-MX&page=${pagina}`);
...
const CargarSeries= async () => {
    try {
        const serie= await fetch(`https://api.themoviedb.org/3/tv/popular?api_key=ff60f9dde54fdfe327e270d3d7cc6307&language=es-ES&page=${pagina}`);
